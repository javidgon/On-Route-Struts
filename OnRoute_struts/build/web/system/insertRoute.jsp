...
<html>
    ...
    <body>
	    ...
	    Logged in as <%= session.getAttribute("email")%>.
                ...
                <% if (null != session.getAttribute("email")) {%>
        <h1>New Route</h1>
        <html:form action="/insertRoute">
            <div class="newform">
                <table>
                    <tbody>
                        <tr>
                            <td>
                                <bean:write name="InsertRouteForm" property="error" filter="false"/>
                                &nbsp;</td>
                        </tr>
                        ...
                        <tr><td><html:text property="province"></html:text></td></tr>
                        <tr><td>City</td></tr>
                        <tr><td><html:text property="city"></html:text></td></tr>
                        <tr><td>Description (Max. 200 characters)</td></tr>
                        <tr><td><html:textarea property="description" cols="30" rows="20"></html:textarea></td></tr>
                        <tr><td class="actions"><html:submit value="Insert Route"/></td>
