 ...
 * @author javidgon
 */
public class EditRouteConfirmationAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        HttpSession session = request.getSession(true);
             // extract user data
        EditRouteForm formBean = (EditRouteForm) form;
        String name = ((InsertRouteForm)session.getAttribute("route")).getName();
...
// perform validation
        ...
        if (!message.equals("Errors: <br/>")) {
            ...
            onRouteDB.updateRoute(formBean);
